...
export default function ScaledSnowGlobe(props) {
  ...
  //   metalness,
  // } = useControls({
  //   backsideThickness: { value: 8, min: 0, max: 20 },
  //   samples: { value: 4, min: 1, max: 10, step: 1 },
  //   thickness: { value: 0.9, min: 0, max: 5 },
  //   anisotropicBlur: { value: 0.8, min: 0, max: 1 },
  //   ior: { value: 1.8, min: 1, max: 2.5 },
  //   iridescence: { value: 0.5, min: 0, max: 1 },
  //   iridescenceIOR: { value: 1, min: 0.5, max: 2 },
  //   iridescenceThicknessRange: {
  //     value: [0, 1400],
  //     min: 0,
  //     max: 2000,
  ...
  //   envMapIntensity: { value: 0.7, min: 0, max: 2 },
  ...
  return (
    <group {...props} dispose={null} position={[0, -1, 0]}>
      ...
      <mesh ref={internalWorldRef} position={[0, 0, 0]}>
        ...
        {window.innerWidth >= 1024 && <FireWorks
        // ref={fireWorksRef} 
        />}
      </mesh>
